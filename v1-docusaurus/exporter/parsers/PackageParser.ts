...
import { ExApiPackageDef, ExApiDocItem, createPackageDef } from '../definitions';
import { extractTitle, extractMainName, extractNamespace, extractBreadcrumbs, extractAvailableTokens } from '../extractors';
import { BaseParser } from './BaseParser';

/**
 * Parser for Package pages
 */
export class PackageParser extends BaseParser<ExApiPackageDef> {
  /**
   * Check if the page is a package page
   */
   ...
   */
  parse($: cheerio.CheerioAPI, sourcePath: string): ExApiPackageDef | null {
