...
- `onUpdate`: Called every frame. Use this for game logic and for `ZActionPlayer.update()` when playing skeletal clips (see [Playing skeletal animations](/docs/quick-start/skeletal-animation)).
...
- [Loading a model (.zko)](/docs/quick-start/loading-a-model) — assets paths, `loadFromProto` / `loadFromUrl`, and `findFirstModel`
- [Playing skeletal animations](/docs/quick-start/skeletal-animation) — `ZActionPlayer`, clips, and `onUpdate`
- [Scene & camera](/docs/quick-start/scene-and-camera) — scene graph, default scene, and `activeCamera`
- [Lighting your scene](/docs/quick-start/scene-lighting) — light types and engine limits
